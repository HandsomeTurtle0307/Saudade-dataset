...
> 由于我用我的数据集微调大模型时，在合并LoRA权重以及使用WebUI的过程中深受Python软件包的版本兼容，以及各种其它奇奇怪怪的问题的折磨，所以我决定暂时停止开发Saudade-dataset，转而开发一个图形化界面的合并大模型的工具，使用Qt和C++完成，具体请见 https://github.com/HandsomeTurtle0307/OllaMerge
